...
import { SimplePlannerWithDeleteComponent } from './components/planner/simple-planner-with-delete/simple-planner-with-delete.component';
...
@NgModule({
  declarations: [
    ...
    SimplePlannerWithDeleteComponent,
    FormsComponent,
    LoginFormComponent,
    SignupFormComponent,
    CharactersComponent,
